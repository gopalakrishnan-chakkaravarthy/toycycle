...
export const inventory = pgTable("inventory", {
  ...
  redistributedToPartnerId: integer("redistributed_to_partner_id").references(
    () => partners.id
  ),
...
export const pickups = pgTable("pickups", {
  ...
  toyConditionId: integer("toy_condition_id")
    .references(() => toyConditions.id)
    .notNull(),
...
export type EcommerceIntegration = InferSelectModel<
  typeof ecommerceIntegrations
>;
export type NewEcommerceIntegration = InferInsertModel<
  typeof ecommerceIntegrations
>;
