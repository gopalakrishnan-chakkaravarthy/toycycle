    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="max-w-4xl">
        <DialogHeader>
          <DialogTitle>
            Schedule Pickup for{" "}
            {selectedDate ? format(selectedDate, "PPP") : "your selected date"}
          </DialogTitle>
          <DialogDescription>
            Fill out the form below to finalize your donation pickup.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="grid gap-8 md:grid-cols-2 pt-4">
          ...
          <div className="hidden md:flex flex-col">
            <CardHeader className="p-0 pb-4">
              ...
              <CardDescription>
                Confirm the location on the map below.
              </CardDescription>
            </CardHeader>
              ...
              <div className="flex items-start gap-3 p-4 bg-muted/50 rounded-lg">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-sm text-muted-foreground min-h-10">
                    {pickupType === "my-address"
                      ? form.watch("address") ||
                        "Enter an address to see it here."
                      : pickupType === "drop-off" && locationId
                      ? locations.find((l) => String(l.id) === locationId)
                          ?.address
                      : pickupType === "partner" && partnerId
                      ? `Pickup from ${
