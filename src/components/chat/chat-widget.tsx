  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    startTransition(async () => {
        ...
        try {
            ...
            const modelMessage: Message = { role: 'model', content: response.text ?? "Sorry, I couldn't process that." };
        ...
        {isOpen && (
            ...
            <CardHeader>
                <CardTitle className="flex items-center gap-2">
                 ...
                 <CardDescription>I can help schedule pickups and check status.</CardDescription>
            </CardHeader>
